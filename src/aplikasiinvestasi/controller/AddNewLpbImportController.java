 ...
 */
public class AddNewLpbImportController {
    private MainPageLpbController mainPage;
    private AddLpbImport addLpb;
    ...
    public void saveData(java.awt.event.ActionEvent awt){
         if(lpbService.saveInBatch(listMaster)){
            empty();
            addLpb.getNomorLpbEksternalField().setText("");
            addLpb.getNomorLpbInternalField().setText("");
            mainPage.getAllData();

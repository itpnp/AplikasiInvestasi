 ...
 */
public class PrintOptionInvest extends javax.swing.JDialog {

    /**
     * Creates new form PrintOptionInvest
     */
    public PrintOptionInvest(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintOptionInvest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrintOptionInvest dialog = new PrintOptionInvest(new javax.swing.JFrame(), true);
